...
def evaluate(
    ...
    print(f"\nReorient MJX eval (n={n_episodes})")
    ...
    if record_video and video_frames:
        ...
        video_path = vdir / "reorient_mjx_evaluation.mp4"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate SBX-trained reorientation model")
