...
def run_episodes(
    ...
    """Run n_episodes and collect success/force/slip metrics."""
...
def main() -> None:
    ...
    for cond_name, variants in all_results.items():
        ...
        print(f"  {'contact force (N)':>26} {t['mean_contact_force']:>10.2f} {b['mean_contact_force']:>10.2f}")
        print(f"  {'slips/ep':>26} {t['slip_events_per_ep']:>10.2f} {b['slip_events_per_ep']:>10.2f}")
        print(f"  {'insertion time':>26} {t['mean_insertion_time']:>10.1f} {b['mean_insertion_time']:>10.1f}")
